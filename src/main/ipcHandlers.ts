...
export function registerIpcHandlers(mainWindow: BrowserWindow): void {
  ipcMain.handle(IPC_CHANNELS.BOARD_NEW, async () => {
  ...
  ipcMain.handle(IPC_CHANNELS.BOARD_OPEN, async () => {
  ...
  ipcMain.handle(IPC_CHANNELS.BOARD_OPEN_PATH, async (_event, filePath: string) => {
  ...
  ipcMain.handle(IPC_CHANNELS.RECENT_LIST, async () => {
